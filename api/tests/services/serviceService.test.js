...
describe('Service Business Logic (Service Layer)', () => {
    ...
    describe('Creating a Service', () => {
        it('should successfully create a new service and return success message', async () => {
            ...
            const result = await serviceService.createService('Lawn Mowing', 'Lawn mowing and edging service', true);
        ...
        it('should create a service with is_available defaulting to true', async () => {
            Service.create.mockResolvedValue({ ...mockService, name: 'Tree Trimming', description: 'Tree trimming and removal service', is_available: true });
    ...
    describe('Fetching a Service by ID', () => {
        it('should return the service when found', async () => {
            ...
            expect(result.description).toBe('Lawn mowing and edging service');
        });
    ...
    describe('Updating a Service', () => {
        it('should successfully update a service and return the updated service', async () => {
            ...
            const result = await serviceService.updateService(1, 'Updated Lawn Mowing', 'Updated description', false);

            expect(Service.findByPk).toHaveBeenCalledWith(1);
            expect(mockService.update).toHaveBeenCalledWith({ name: 'Updated Lawn Mowing', description: 'Updated description', is_available: false });
        ...
        it('should return null if the service to update does not exist', async () => {
            ...
            const result = await serviceService.updateService(999, 'Updated Service', 'Updated description', true);
        ...
        it('should throw an error if update operation fails', async () => {
            ...
            await expect(serviceService.updateService(1, 'New Name', 'New Description', true)).rejects.toThrow('Update failed');
        });
    });
