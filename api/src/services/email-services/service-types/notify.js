...
const sendAdminNotificationEmail = async (appointment) => {
        ...
        <div style="font-family: ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
            ...
            <div style="padding: 30px 20px; background-color: #ffffff;">
                ...
                <p style="color: #475569; font-size: 16px; line-height: 1.6;">
                    A new service appointment request has just been submitted via the website. Below are the details of the request:
                </p>
                
                <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; border-left: 4px solid #16a34a; margin: 24px 0;">
    ...
    const mailOptions = {
        ...
        to: ownerEmail,
        replyTo: appointment.email, // Allows the owner to hit "Reply" and email the customer directly
        subject: `New Service Request: ${appointment.name}`,
        html: htmlBody
    };
